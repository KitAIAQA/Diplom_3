...
class MainPageLocators:
    # Элемент лоадер загрузки веб-страницы
    ...
    COMPLETED_ORDERS = (By.XPATH, "//p[contains(text(),'Готовы:')]")  # Готов
    ...
    ORDER_SUCCESS_MESSAGE = (By.XPATH,
                             "//p[@class='undefined text text_type_main-small mb-2']")

    ORDER_IN_PROGRESS_LOCATOR = (
        By.XPATH,
        "//ul[@class='OrderFeed_orderListReady__1YFem OrderFeed_orderList__cBvyi']//li[1]//*[contains(text(), '{0}')]"
    )
